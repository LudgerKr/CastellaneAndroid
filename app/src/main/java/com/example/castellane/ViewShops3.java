...
public class ViewShops3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shops_view3);
    ...
    class DBShops extends AsyncTask<Void, Void, ArrayList<Shops>> {
        ...
        protected ArrayList<Shops> doInBackground(Void... voids) {
            String url = Constant.SERVER + "get_shops.php?idshop=" +3;
