...
public class ViewAdminMonitorList extends AppCompatActivity implements View.OnClickListener {

    private Button btnBackViewRightMonitor, btnModifyRightMonitor;
    private ListView listMonitorList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rightmonitor_view);

        this.btnBackViewRightMonitor = findViewById(R.id.btnBackViewRightMonitor);
        this.btnModifyRightMonitor = findViewById(R.id.btnModifyRightMonitor);

        this.btnBackViewRightMonitor.setOnClickListener(this);
        this.btnModifyRightMonitor.setOnClickListener(this);

        this.listMonitorList = findViewById(R.id.listMonitor);

        this.email = this.getIntent().getStringExtra("email");
        this.userId = this.getIntent().getStringExtra("userId");


        final ViewAdminMonitorList sp = this;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnModifyRightMonitor) {
            Intent intent = new Intent(this, ChangeUserRight.class);
            intent.putExtra("email", this.email);
            intent.putExtra("userId", this.userId);
            this.startActivity(intent);
        } else if (v.getId() == R.id.btnBackViewRightMonitor) {
    ...
    public void remplirLV() {
        if (usersLists != null) {
            ...
            listMonitorList.setAdapter(adapter);
        } else {
    ...
    class DBusersLists extends AsyncTask<Void, Void, ArrayList<UsersList>> {
        ...
        protected ArrayList<UsersList> doInBackground(Void... voids) {
            String url = Constant.SERVER + "get_allMoniteur.php";
