...
public class ModifyVehicles extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_vehicles_update);
        ...
        this.spUpdateStatus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(ModifyVehicles.this, "Selected : "+ status.get(position),
    ...
    class GetVehicle extends AsyncTask<String, Void, Vehicles> {
        private WeakReference<ModifyVehicles> activityReference;

        GetVehicle(ModifyVehicles context) {
        ...
        protected void onPostExecute(Vehicles vehicle) {
            ModifyVehicles vehicleActivity = activityReference.get();
            if (vehicle != null) {
    ...
    class UpdateVehicle extends AsyncTask<Vehicles, Void, Void> {
        ...
        UpdateVehicle(ModifyVehicles context) {
            activityReference = new WeakReference<>(context);
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ModifyVehicles modifyvehicle = activityReference.get();
