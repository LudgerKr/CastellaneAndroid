...
public class ViewMonitorSeances extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitor_seances_view);
        ...
        final ViewMonitorSeances sp = this;
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btnBackViewSeance) {
            ...
            Intent intent  = new Intent(this, ViewMonitorSeances.class);
    ...
    class SeanceInscrire extends AsyncTask<String, Void, Void> {
        private WeakReference<ViewMonitorSeances> activityReference;

        SeanceInscrire(ViewMonitorSeances context) {
        ...
        protected void onPostExecute(Void aVoid) {
            ViewMonitorSeances seanceActivity = activityReference.get();
            if (seanceActivity == null || seanceActivity.isFinishing()) return ;
            Intent intent = new Intent(seanceActivity, ViewMonitorSeances.class);
