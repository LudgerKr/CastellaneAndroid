...
public class AddMonitorVehicles extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitor_vehicles_add);
        ...
        this.spAddStatus.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(AddMonitorVehicles.this, "Selected : "+ status.get(position),
    ...
    class NewVehicle extends AsyncTask<Vehicles, Void, Void> {
        private WeakReference<AddMonitorVehicles> activityReference;

        NewVehicle(AddMonitorVehicles context) {
        ...
        protected void onPostExecute(Void aVoid) {
            AddMonitorVehicles addAnnonce = activityReference.get();
