...
public class ViewMonitorVehicles extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_monitor_vehicles_view);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btnBackViewVehicles) {
            Intent intent = new Intent(this, MenuMoniteur.class);
            intent.putExtra("email", this.email);
            intent.putExtra("userId", this.userId);
            this.startActivity(intent);
        } else if (v.getId() == R.id.btnAddVehicles) {
            Intent intent = new Intent(this, AddMonitorVehicles.class);
            intent.putExtra("email", this.email);
            intent.putExtra("userId", this.userId);
            this.startActivity(intent);
        } else if (v.getId() == R.id.btnModifyVehicles) {
            Intent intent = new Intent(this, ModifyMonitorVehicles.class);
    ...
    class VehicleDelete extends AsyncTask<String, Void, Void> {
        private WeakReference<ViewMonitorVehicles> activityReference;

        VehicleDelete(ViewMonitorVehicles context) {
        ...
        protected void onPostExecute(Void aVoid) {
            ViewMonitorVehicles vehicleActivity = activityReference.get();
            ...
            Intent intent = new Intent(vehicleActivity, ViewMonitorVehicles.class);
